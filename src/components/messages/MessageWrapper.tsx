  ...
  if (showDate) {
    return (
      <MessageWithDate message={message} id={message.sid} ref={ref}>
        <Message message={message} showTime={showTime} incoming={incoming} />
      </MessageWithDate>
    );
  }

  return (
    <Message message={message} showTime={showTime} incoming={incoming} id={message.sid} ref={ref} />
  );
};
...
export default connector(MessageWrapper);
